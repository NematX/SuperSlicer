...
std::string FanMover::_set_fan(int16_t speed) {
    ...
    std::string str = GCodeWriter::set_fan(m_writer.config.gcode_flavor.value, m_writer.config.gcode_comments.value, speed, tool ? tool->fan_offset() : 0, tool ? tool->id() : 0, m_writer.config.fan_percentage.value);
