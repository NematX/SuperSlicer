...
public:
    ...
    static std::string set_fan(const GCodeFlavor gcode_flavor, bool gcode_comments, uint8_t speed, uint8_t tool_fan_offset, uint16_t tool_id, bool is_fan_percentage, const std::string comment = "");
