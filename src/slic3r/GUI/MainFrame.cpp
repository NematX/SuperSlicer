...
//            [this](){return can_export_model(); }, this);
    ...
    if (wxGetApp().is_editor())
    {
        ...
        append_menu_item(m_calibration_menu, wxID_ANY, _(L("Filament Flow Speed calibration")), _(L("Create a test print to help you to set your filament extrusion multiplier curve for a range of speed (precision scale needed).")),
